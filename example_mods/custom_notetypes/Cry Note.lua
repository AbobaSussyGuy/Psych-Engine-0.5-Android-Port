function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Cry Note' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'CRYNOTE_assets'); --Change texture
